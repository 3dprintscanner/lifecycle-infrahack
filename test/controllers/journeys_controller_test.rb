...
class JourneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journey" do
    assert_difference('Journey.count') do
      post journeys_url, params: { journey: { destination: @journey.destination, origin: @journey.origin, owner_id: @journey.owner_id, vehicle_id: @journey.vehicle_id } }
    end
  ...
  test "should update journey" do
    patch journey_url(@journey), params: { journey: { destination: @journey.destination, origin: @journey.origin, owner_id: @journey.owner_id, vehicle_id: @journey.vehicle_id } }
